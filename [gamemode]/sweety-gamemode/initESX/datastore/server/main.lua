...
AddEventHandler('::{razzway.xyz}::esx_datastore:getDataStore', function(name, owner, cb)
	cb(GetDataStore(name, owner))
end)

AddEventHandler('::{razzway.xyz}::esx_datastore:getSharedDataStore', function(name, cb)
