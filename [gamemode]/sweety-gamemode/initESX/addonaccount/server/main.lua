...
AddEventHandler('::{razzway.xyz}::esx_addonaccount:getAccount', function(name, owner, cb)
	cb(GetAccount(name, owner))
end)

AddEventHandler('::{razzway.xyz}::esx_addonaccount:getSharedAccount', function(name, cb)
