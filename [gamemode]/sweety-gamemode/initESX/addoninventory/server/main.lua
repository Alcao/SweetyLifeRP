...
AddEventHandler('::{razzway.xyz}::esx_addoninventory:getInventory', function(name, owner, cb)
	cb(GetInventory(name, owner))
end)

AddEventHandler('::{razzway.xyz}::esx_addoninventory:getSharedInventory', function(name, cb)
