...
robberiesConfiguration = {
    ...
    items = {
        ["TV"] = {name = "Téléviseur", resellerValue = 3500, timeToTake = 30},
        ["CLOTHS"] = {name = "Vêtements", resellerValue = 850, timeToTake = 15},
        ["CLOTHSRICHE"] = {name = "Vêtements de Luxe", resellerValue = 2500, timeToTake = 15},
        ["ECOMP"] = {name = "Composants électroniques", resellerValue = 200, timeToTake = 4},
        ["ORANGE"] = {name = "Fruits", resellerValue = 150, timeToTake = 2},
        ["TELEPHONE"] = {name = "iPhone", resellerValue = 350, timeToTake = 4},
        ...
        ["BOITEBIJOUX"] = {name = "Boite a Bijoux", resellerValue = 1000, timeToTake = 20},
        ...
        ["COMPRESSEUR"] = {name = "Compresseur", resellerValue = 1000, timeToTake = 12},
        ...
        ["BANSHEE"] = {name = "Tableau Banshee", resellerValue = 850, timeToTake = 8},
        ...
        ["COCAINA"] = {name = "Cocaine", resellerValue = 250, timeToTake = 4},
        ...
        ["SECHECHEVEUX"] = {name = "Seche Cheveux", resellerValue = 250, timeToTake = 3},
        ["LIVRES"] = {name = "Livres", resellerValue = 450, timeToTake = 8},
        ["JACK"] = {name = "Bouteille de Jack", resellerValue = 189, timeToTake = 2},
    },
    ...
    houses = {
        -- Première maison
        {
            ...
            copsCalledAfter = 35,  -- s
            policeBlipDuration = 40, -- s
            maximumTime = 60,  -- s
        ...
        -- Maison Riche 1
        {
            ...
            authority = "police",
            timeToGoToReseller = 10, -- minutes
            copsCalledAfter = 25,  -- s
            policeBlipDuration = 90, -- s
            maximumTime = 120,  -- s
