                ...
                while pSociety.Menu do
                    RageUI.IsVisible(RMenu:Get('bossmenu', 'main'), pSocietyCFG.Banner.Display, true, true, function()
                        ...
                        if closestPlayer ~= -1  and closestDistance <= 5.0 then
                            RageUI.ButtonWithStyle(pSociety.Trad["recruit"], pSociety.Trad["recruit_desc"], {}, true, function(Hovered, Active, Selected)
                                if Active then
                                    ...
                                    if Selected then
                                        SwLife.InternalToServer("pSociety:RequestSetRecruit", GetPlayerServerId(closestPlayer), _society.name)
                                    end
                                end
                            end)
                        end
                        ...
                        if _options.money then
                            ...
                            RageUI.ButtonWithStyle(pSociety.Trad["withdraw_money"], false, {}, true, function(Hovered, Active, Selected)
                                if Selected then
                                    result = pSociety.KeyboardInput("pick", pSociety.Trad["how_much"], "", 8)
                                    if result ~= nil and result ~= "" then
                                        result = ESX.Math.Round(tonumber(result))
                                        if result > 0 then
                                            SwLife.InternalToServer('pSociety:withdrawMoney', _society.name, result)
                            ...
                            RageUI.ButtonWithStyle(pSociety.Trad["deposit_money"], false, {}, true, function(Hovered, Active, Selected)
                                if Selected then
                                    result = pSociety.KeyboardInput("deposit", pSociety.Trad["how_much"], "", 8)
                                    if result ~= nil and result ~= "" then
                                        result = ESX.Math.Round(tonumber(result))
                                        if result > 0 then
                                            SwLife.InternalToServer('pSociety:depositMoney', _society.name, result)
                                            SetTimeout(100, function()
                                                pSociety.RefreshMoney(_society.name)
                                            end)
                                        else
                        ...
                        if _options.wash and _society.percent then
                            RageUI.ButtonWithStyle(pSociety.Trad["wash_money"], pSociety.Trad["wash_money_desc"].." (".._society.percent.."%).", {}, true, function(Hovered, Active, Selected)
                                if Selected then
                                    ...
                                    if result ~= nil and result ~= "" then
                                        if result >= 2 then
                                            ...
                                            SwLife.InternalToServer('pSociety:washMoney', _society.name, result)
                                            SetTimeout(100, function()
                                                pSociety.RefreshMoney(_society.name)
                                            end)
                                        else
                        ...
                        if _options.employees then
                            RageUI.ButtonWithStyle(pSociety.Trad["manage_employees"], false, {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                                if Selected then
                        ...
                        if _options.grades then
                            RageUI.ButtonWithStyle(pSociety.Trad["manage_salary"], pSociety.Trad["manage_salary_desc"], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                                if Selected then
                    ...
                    RageUI.IsVisible(RMenu:Get('bossmenu', 'manage_employees'), pSocietyCFG.Banner.Display, true, true, function()
                        RageUI.ButtonWithStyle(pSociety.Trad["search"], false, {RightLabel = filterstring}, true, function(Hovered, Active, Selected)
                            if Selected then
                        ...
                        for i=1, #pSociety.EmployeesList do
                            ...
                            if filterstring == nil or string.find(ply.name, filterstring) or string.find(ply.job.grade_label, filterstring) then
                                RageUI.ButtonWithStyle(ply.name, false, {RightLabel = "~b~"..ply.job.grade_label.."~s~ →"}, true, function(Hovered, Active, Selected)
                                    if Selected then
                                        pSociety.RefeshjobInfos(_society.name)
                    ...
                    RageUI.IsVisible(RMenu:Get('bossmenu', 'update_employee'), pSocietyCFG.Banner.Display, true, true, function()
                        ...
                        for i=1, #pSociety.JobList, 1 do
                            ...
                            if SelectedEmployee.job.grade ~= jb.grade then
                                RageUI.ButtonWithStyle(jb.label, false, {RightLabel = pSociety.Trad["choose"]}, true, function(Hovered, Active, Selected)
                                    if Selected then
                                ...
                                RageUI.ButtonWithStyle(jb.label, false, {RightLabel = pSociety.Trad["current"]}, true, function(Hovered, Active, Selected)
                                end)
                            end
                        end
    
                        RageUI.ButtonWithStyle(pSociety.Trad["kick_society"], false, {RightBadge = RageUI.BadgeStyle.Alert}, true, function(Hovered, Active, Selected)
                            if Selected then
                    ...
                    RageUI.IsVisible(RMenu:Get('bossmenu', 'manage_salary'), pSocietyCFG.Banner.Display, true, true, function()
                        ...
                        for i=1, #pSociety.JobList, 1 do
                            ...
                            RageUI.ButtonWithStyle(jb.grade..". "..jb.label, false, {RightLabel = "~g~"..jb.salary.." "..pSociety.Trad["money_symbol"]}, true, function(Hovered, Active, Selected)
                                if Selected then
