Locales['fr'] = {
	['press'] = 'Appuyez sur ~INPUT_CONTEXT~ pour accéder au menu',
	['shop'] = 'Supérette',
	['press_menu'] = 'appuyez sur ~INPUT_CONTEXT~ pour ~g~accéder~s~ au magasin.',
	...
	-- Main Menu
	['mainmenu_subtitle'] = 'Connecté en tant que',
	...
	['wallet_job_button'] = 'Votre emploi : %s - %s',
	['wallet_job2_button'] = 'Votre organisation : %s - %s',
	['wallet_money_button'] = '~g~Argent Propre~s~ : $%s',
	['wallet_bankmoney_button'] = '~b~Argent Banque~s~ : $%s',
	['wallet_dirtycash_button'] = '~r~Argent Sale~s~ : $%s',
