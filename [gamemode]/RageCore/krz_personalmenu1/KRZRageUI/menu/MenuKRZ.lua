...
---@return table
---@public
function RageUI2.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
	---@type table
	local Menu = {}
	...
	Menu.DescriptionHeight = RageUI2.Settings.Items.Description.Background.Height
	Menu.X = X or 0
	Menu.Y = Y or 0
	Menu.Parent = nil
	Menu.WidthOffset = 0
	Menu.Open = false
	Menu.Controls = RageUI2.Settings.Controls
	Menu.Index = 1
	...
	if Menu.Subtitle ~= "" then
		local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + RageUI2.Settings.Items.Subtitle.Text.X, Menu.Y + RageUI2.Settings.Items.Subtitle.Text.Y, 0, RageUI2.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUI2.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
	...
	return setmetatable(Menu, RageUI2.Menus)
end
...
---@return table
---@public
function RageUI2.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
...
---@return void
---@public
function RageUI2.Menus:SetTitle(Title)
	self.Title = Title
end
...
---@return void
---@public
function RageUI2.Menus:RefreshIndex()
	self.Index = 1
end
...
---@return void
---@public
function RageUI2.Menus:SetSubtitle(Subtitle)
	...
	if self.Subtitle ~= "" then
		local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + RageUI2.Settings.Items.Subtitle.Text.X, self.Y + RageUI2.Settings.Items.Subtitle.Text.Y, 0, RageUI2.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUI2.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return void
---@public
function RageUI2.Menus:SetPageCounter(Subtitle)
...
---@return void
---@public
function RageUI2.Menus:EditSpriteColor(color)
...
---@return void
---@public
function RageUI2.Menus:SetPosition(X, Y)
...
---@return void
---@public
function RageUI2.Menus:SetTotalItemsPerPage(Value)
...
---@return void
---@public
function RageUI2.Menus:SetRectangleBanner(R, G, B, A)
...
---@return void
---@public
function RageUI2.Menus:SetSpriteBanner(TextureDictionary, Texture)
	self.Sprite = { Dictionary = TextureDictionary or "sooyoanalanal", Texture = Texture or "interaction_bgd" }
	self.Rectangle = nil
end

function RageUI2.Menus:Closable(boolean)
...
function RageUI2.Menus:AddInstructionButton(button)
...
function RageUI2.Menus:RemoveInstructionButton(button)
...
function RageUI2.Menus:UpdateInstructionalButtons(Visible)
	if not Visible then
		return
	end
