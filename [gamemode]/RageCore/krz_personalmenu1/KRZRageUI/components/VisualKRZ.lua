...
RegisterNetEvent("RageUI2:Popup")
AddEventHandler("RageUI2:Popup", function(array)
    RageUI2.Popup(array)
end)
...
---@param array table
---@public
function RageUI2.PopupChar(array)
    if (array.colors == nil) then
        SetNotificationBackgroundColor(140)
    else
        SetNotificationBackgroundColor(array.colors)
