...
---@return nil
---@public
function RageUIRZ.GoUp(Options)
    ...
    if CurrentMenu ~= nil then
        ...
        if CurrentMenu() then
            if (Options ~= 0) then
                ...
                local Audio = RageUIRZ.Settings.Audio
                RageUIRZ.PlaySound(Audio[Audio.Use].Error.audioName, Audio[Audio.Use].Error.audioRef)
            end
        end
    end
end
...
---@return nil
---@public
function RageUIRZ.GoDown(Options)
    local CurrentMenu = RageUIRZ.CurrentMenu;
    if CurrentMenu ~= nil then
        Options = CurrentMenu.Options
        if CurrentMenu() then
...
function RageUIRZ.GoActionControl(Controls, Action)
...
function RageUIRZ.GoActionControlSlider(Controls, Action)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() then
            if CurrentMenu.Open then
                ...
                RageUIRZ.Options = CurrentMenu.Options
                ...
                for i = 1, #ControlActions do
                    RageUIRZ.GoActionControl(Controls, ControlActions[i])
                end

                RageUIRZ.GoActionControlSlider(Controls, 'SliderLeft')
                RageUIRZ.GoActionControlSlider(Controls, 'SliderRight')
...
function RageUIRZ.Navigation()
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Navigation) then
            ...
            if RageUIRZ.Options > CurrentMenu.Pagination.Total then
                ...
                if CurrentMenu.EnableMouse then
                    UpHovered = RageUIRZ.IsMouseInBounds(CurrentMenu.X + CurrentMenu.SafeZoneSize.X, CurrentMenu.Y + CurrentMenu.SafeZoneSize.Y + CurrentMenu.SubtitleHeight + RageUIRZ.ItemOffset, RageUIRZ.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUIRZ.Settings.Items.Navigation.Rectangle.Height)
                    DownHovered = RageUIRZ.IsMouseInBounds(CurrentMenu.X + CurrentMenu.SafeZoneSize.X, CurrentMenu.Y + RageUIRZ.Settings.Items.Navigation.Rectangle.Height + CurrentMenu.SafeZoneSize.Y + CurrentMenu.SubtitleHeight + RageUIRZ.ItemOffset, RageUIRZ.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUIRZ.Settings.Items.Navigation.Rectangle.Height)

                    if CurrentMenu.Controls.Click.Active then
                        if UpHovered then
                            RageUIRZ.GoUp(RageUIRZ.Options)
                        elseif DownHovered then
                            RageUIRZ.GoDown(RageUIRZ.Options)
                        end
                    end

                    if UpHovered then
                        RenderRectangle(CurrentMenu.X, CurrentMenu.Y + CurrentMenu.SubtitleHeight + RageUIRZ.ItemOffset, RageUIRZ.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUIRZ.Settings.Items.Navigation.Rectangle.Height, 30, 30, 30, 255)
                    else
                        RenderRectangle(CurrentMenu.X, CurrentMenu.Y + CurrentMenu.SubtitleHeight + RageUIRZ.ItemOffset, RageUIRZ.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUIRZ.Settings.Items.Navigation.Rectangle.Height, 0, 0, 0, 200)
                    end

                    if DownHovered then
                        RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUIRZ.Settings.Items.Navigation.Rectangle.Height + CurrentMenu.SubtitleHeight + RageUIRZ.ItemOffset, RageUIRZ.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUIRZ.Settings.Items.Navigation.Rectangle.Height, 30, 30, 30, 255)
                    else
                        RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUIRZ.Settings.Items.Navigation.Rectangle.Height + CurrentMenu.SubtitleHeight + RageUIRZ.ItemOffset, RageUIRZ.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUIRZ.Settings.Items.Navigation.Rectangle.Height, 0, 0, 0, 200)
                    end
                else
                    RenderRectangle(CurrentMenu.X, CurrentMenu.Y + CurrentMenu.SubtitleHeight + RageUIRZ.ItemOffset, RageUIRZ.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUIRZ.Settings.Items.Navigation.Rectangle.Height, 0, 0, 0, 200)
                    RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUIRZ.Settings.Items.Navigation.Rectangle.Height + CurrentMenu.SubtitleHeight + RageUIRZ.ItemOffset, RageUIRZ.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUIRZ.Settings.Items.Navigation.Rectangle.Height, 0, 0, 0, 200)
                end
                RenderSprite(RageUIRZ.Settings.Items.Navigation.Arrows.Dictionary, RageUIRZ.Settings.Items.Navigation.Arrows.Texture, CurrentMenu.X + RageUIRZ.Settings.Items.Navigation.Arrows.X + (CurrentMenu.WidthOffset / 2), CurrentMenu.Y + RageUIRZ.Settings.Items.Navigation.Arrows.Y + CurrentMenu.SubtitleHeight + RageUIRZ.ItemOffset, RageUIRZ.Settings.Items.Navigation.Arrows.Width, RageUIRZ.Settings.Items.Navigation.Arrows.Height)
                RageUIRZ.ItemOffset = RageUIRZ.ItemOffset + (RageUIRZ.Settings.Items.Navigation.Rectangle.Height * 2)
            end
        end
    end
end
