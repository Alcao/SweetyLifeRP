...
local SettingsSlider = {
    ...
    LeftArrow = { Dictionary = "menutoutbo", Texture = "arrowleft", X = 235, Y = 11.5, Width = 15, Height = 15 },
    RightArrow = { Dictionary = "menutoutbo", Texture = "arrowright", X = 400, Y = 11.5, Width = 15, Height = 15 },
}

function RageUIRZ.Slider(Label, ProgressStart, ProgressMax, Description, Divider, Style, Enabled, Actions)
