...
---@param B number
---@param A number
---@return RageUIRZMenus
---@public
function RageUIRZ.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = RageUIRZ.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 0
    Menu.Parent = nil
    Menu.WidthOffset = 0
    Menu.Open = false
    Menu.Controls = RageUIRZ.Settings.Controls
    Menu.Index = 1
    Menu.Sprite = { Dictionary = TextureDictionary or "menutoutbo", Texture = TextureName or "interaction_bgd", Color = { R = R, G = G, B = B, A = A } }
    Menu.Rectangle = nil
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + RageUIRZ.Settings.Items.Subtitle.Text.X, Menu.Y + RageUIRZ.Settings.Items.Subtitle.Text.Y, 0, RageUIRZ.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIRZ.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, RageUIRZ.Menus)
end
...
---@return RageUIRZMenus
---@public
function RageUIRZ.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    if ParentMenu ~= nil then
        if ParentMenu() then
            local Menu = RageUIRZ.CreateMenu(Title or ParentMenu.Title, string.upper(Subtitle) or string.upper(ParentMenu.Subtitle), X or ParentMenu.X, Y or ParentMenu.Y)
...
---@return nil
---@public
function RageUIRZ.Menus:SetTitle(Title)
    self.Title = Title
end

function RageUIRZ.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function RageUIRZ.Menus:GetStyleSize()
...
---@return void
---@public
function RageUIRZ.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function RageUIRZ.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function RageUIRZ.Menus:UpdateCursorStyle()
...
---@return void
---@public
function RageUIRZ.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function RageUIRZ.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + RageUIRZ.Settings.Items.Subtitle.Text.X, self.Y + RageUIRZ.Settings.Items.Subtitle.Text.Y, 0, RageUIRZ.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIRZ.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function RageUIRZ.Menus:SetPageCounter(Subtitle)
...
---@return nil
---@public
function RageUIRZ.Menus:EditSpriteColor(R, G, B, A)
    if self.Sprite.Dictionary == "menutoutbo" then
...
---@return nil
---@public
function RageUIRZ.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function RageUIRZ.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function RageUIRZ.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function RageUIRZ.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "menutoutbo", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function RageUIRZ.Menus:Closable(boolean)
...
function RageUIRZ.Menus:AddInstructionButton(button)
...
function RageUIRZ.Menus:RemoveInstructionButton(button)
...
function RageUIRZ.Menus:UpdateInstructionalButtons(Visible)
