...
---
local AC_GPFSI = AC_GPFSI_PARAM
local AC_P = AC_P_PARAM
            ...
            if (not ContextUI.Open) then
                ...
                if (entityType ~= 0) then
                    ...
                    for k, player in pairs(GetActivePlayers()) do
                        ...
                        if netid == NetworkGetNetworkIdFromEntity(entityHit) then
                            ContextUI.Entity.PlayerID = playerId
                        end
                    end

                    if IsControlJustPressed(0, 24) or AC_IDCP(0, 24) then
                        if (ContextUI.Menus[entityType .. ContextUI.Category] ~= nil) then
                            ...
                            ContextUI.Entity = {
                                ServerID = ContextUI.Entity.PlayerID,
                                ID = entityHit,
                                Type = entityType,
