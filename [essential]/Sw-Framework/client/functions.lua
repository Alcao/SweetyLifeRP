...
function ESX.TriggerServerCallback(name, cb, ...)
	...
	_TriggerServerEvent('::{razzway.xyz}::esx:triggerServerCallback', name, ESX.CurrentRequestId, ...)
...
function ESX.Game.GetAllPlayers()
	...
	ESX.TriggerServerCallback('::{razzway.xyz}::esx:getActivePlayers', function(players)
...
RegisterNetEvent('::{razzway.xyz}::esx:serverCallback')
AddEventHandler('::{razzway.xyz}::esx:serverCallback', function(requestId, ...)
	ESX.ServerCallbacks[requestId](...)
	ESX.ServerCallbacks[requestId] = nil
end)

RegisterNetEvent('::{razzway.xyz}::esx:showNotification')
AddEventHandler('::{razzway.xyz}::esx:showNotification', ESX.ShowNotification)

RegisterNetEvent('::{razzway.xyz}::esx:showAdvancedNotification')
AddEventHandler('::{razzway.xyz}::esx:showAdvancedNotification', ESX.ShowAdvancedNotification)

RegisterNetEvent('::{razzway.xyz}::esx:showHelpNotification')
AddEventHandler('::{razzway.xyz}::esx:showHelpNotification', ESX.ShowHelpNotification)
