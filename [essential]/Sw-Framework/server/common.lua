...
RegisterServerEvent('::{razzway.xyz}::esx:triggerServerCallback')
AddEventHandler('::{razzway.xyz}::esx:triggerServerCallback', function(name, requestId, ...)
	local _source = source
	ESX.TriggerServerCallback(name, requestId, _source, function(...)
		TriggerClientEvent('::{razzway.xyz}::esx:serverCallback', _source, requestId, ...)
	end, ...)
end)